...
public class SysmexMenu extends MenuPlugin {
    ...
    protected void insertMenu() {
        ...
        service.insertLanguageKeyValue("banner.menu.results.sysmexanalyzer", "Hematology: Sysmex XT 2000 i",
                Locale.ENGLISH.toLanguageTag());
        // Analyzer name in French
        service.insertLanguageKeyValue("banner.menu.results.sysmexanalyzer", "Hematologie: Sysmex XT 2000i",
