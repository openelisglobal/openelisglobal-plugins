...
public class FacsCantoIIMenu extends MenuPlugin {
    ...
    protected void insertMenu() {
        ...
        service.insertLanguageKeyValue("banner.menu.results.FacsCantoII", "Immunology: FacsCantoII",
                Locale.ENGLISH.toLanguageTag());
        // Analyzer name in French
        service.insertLanguageKeyValue("banner.menu.results.FacsCantoII", "Immunologie: FacsCantoII",
