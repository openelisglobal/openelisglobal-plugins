...
public class FacsPrestoMenu extends MenuPlugin {
	...
	protected void insertMenu() {
        ...
        service.insertLanguageKeyValue("banner.menu.results.FacsPrestoanalyzer","Immunology: FacsPresto", ConfigurationProperties.LOCALE.ENGLISH.getRepresentation());
		//Analyzer name in French
        service.insertLanguageKeyValue("banner.menu.results.FacsPrestoanalyzer","Immunologie: FacsPresto", ConfigurationProperties.LOCALE.FRENCH.getRepresentation());
	}
