...
public class TaqMan48DBSMenu extends MenuPlugin {
	...
	protected void insertMenu() {
        ...
        service.insertLanguageKeyValue("banner.menu.results.taqman48dbsanalyzer","Virologie: Cobas TaqMan48 DNA PCR", ConfigurationProperties.LOCALE.ENGLISH.getRepresentation());
		//Analyzer name in French
        service.insertLanguageKeyValue("banner.menu.results.taqman48dbsanalyzer","Virologie: Cobas TaqMan48 DNA PCR", ConfigurationProperties.LOCALE.FRENCH.getRepresentation());
	}
