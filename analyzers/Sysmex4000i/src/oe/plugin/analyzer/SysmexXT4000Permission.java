...
/**
 */
public class SysmexXT4000Permission extends PermissionPlugin{
    @Override
    protected boolean insertPermission(){
        PluginPermissionService service = new PluginPermissionService();
        SystemModule module = service.getOrCreateSystemModule( "AnalyzerResults", "SysmexXT4000Analyzer", "Results->Analyzer->SysmexXT4000Analyzer" );
