...
public class SysmexXT4000Analyzer implements AnalyzerImporterPlugin {


    public boolean connect(){
        List<PluginAnalyzerService.TestMapping> nameMappinng = new ArrayList<PluginAnalyzerService.TestMapping>();
        getInstance().addAnalyzerDatabaseParts("SysmexXT4000Analyzer", "Plugin for Sysmex XT 4000i analyzer",nameMappinng);
    ...
    public boolean isTargetAnalyzer(List<String> lines) {
    	...
    	if (lines.size() > 2 ) { 
    		...
    		String[] data = lines.get(2).split(",");
    		if (data[idInstrumentIndex].contains("XT-4000i")) {
    			return true;
    		}
    ...
    public AnalyzerLineInserter getAnalyzerLineInserter() {
        return new SysmexXT4000AnalyzerImplementation();
    }
}
