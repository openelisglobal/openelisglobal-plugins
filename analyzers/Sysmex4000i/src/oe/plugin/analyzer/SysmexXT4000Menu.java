...
public class SysmexXT4000Menu extends MenuPlugin {
	...
	protected void insertMenu() {
		...
		menu.setElementId("sysmex_xt_4000_analyzer_plugin");
		...
		menu.setActionURL("/AnalyzerResults.do?type=SysmexXT4000Analyzer");
		//The key used for the name of the analyzer on the menu.  Should not already exist in MessageResource.properties.
		menu.setDisplayKey("banner.menu.results.sysmexxt4000analyzer");
		menu.setOpenInNewWindow(false);

        service.addMenu(menu);
		//Analyzer name in English
        service.insertLanguageKeyValue("banner.menu.results.sysmexxt4000analyzer","Hematology: Sysmex XT 4000 i", ConfigurationProperties.LOCALE.ENGLISH.getRepresentation());
		//Analyzer name in French
        service.insertLanguageKeyValue("banner.menu.results.sysmexxt4000analyzer","Hematologie: Sysmex XT 4000i", ConfigurationProperties.LOCALE.FRENCH.getRepresentation());
	}
