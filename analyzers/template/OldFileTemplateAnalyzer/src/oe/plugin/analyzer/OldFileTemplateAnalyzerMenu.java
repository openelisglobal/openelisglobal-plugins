...
public class OldFileTemplateAnalyzerMenu extends MenuPlugin {
    ...
    protected void insertMenu() {
        ...
        menu.setElementId("OldFileTemplateAnalyzer_plugin");
        ...
        menu.setActionURL("/AnalyzerResults?type=OldFileTemplateAnalyzer");
        // The key used for the name of the analyzer on the menu. Should not already
        // exist in MessageResource.properties.
        menu.setDisplayKey("banner.menu.results.oldfiletemplateanalyzer");
        menu.setOpenInNewWindow(false);

        service.addMenu(menu);
        // Analyzer name in English
        service.insertLanguageKeyValue("banner.menu.results.oldfiletemplateanalyzer", "OldFileTemplateAnalyzer_en",
                Locale.ENGLISH.toLanguageTag());
        // Analyzer name in French
        service.insertLanguageKeyValue("banner.menu.results.oldfiletemplateanalyzer", "OldFileTemplateAnalyzer_fr",
