...
public class FacsCaliburMenu extends MenuPlugin {
    ...
    protected void insertMenu() {
        ...
        service.insertLanguageKeyValue("banner.menu.results.FacsCalibur", "Immunology: FacsCalibur",
                Locale.ENGLISH.toLanguageTag());
        // Analyzer name in French
        service.insertLanguageKeyValue("banner.menu.results.FacsCalibur", "Immunologie: FacsCalibur",
