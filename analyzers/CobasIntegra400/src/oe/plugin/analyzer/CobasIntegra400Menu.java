...
public class CobasIntegra400Menu extends MenuPlugin {
    ...
    protected void insertMenu() {
        ...
        service.insertLanguageKeyValue("banner.menu.results.CobasIntegra400", "Biochemistry: Cobas Integra 400+",
                Locale.ENGLISH.toLanguageTag());
        // Analyzer name in French
        service.insertLanguageKeyValue("banner.menu.results.CobasIntegra400", "Biochimie: Cobas Integra 400+",
